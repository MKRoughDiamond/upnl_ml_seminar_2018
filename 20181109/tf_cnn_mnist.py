...
with g.as_default():
    ...
    layer1 = tf.layers.conv2d(X, 32, [3, 3], strides=2, activation=tf.nn.relu)     # [BATCH_SIZE, 28, 28, 1] -> [BATCH_SIZE, 14, 14, 32]


    layer2 = tf.layers.conv2d(layer1, 64, [3, 3], strides=2, activation=tf.nn.relu) # [BATCH_SIZE, 14, 14, 32] -> [BATCH_SZIE, 7, 7, 64]
